...
- [LangChain with NexusSecureTool](#langchain-with-nexussecuretool)
...
The simplest possible Nexus Guard integration:

```python
from nexus_guard import NexusFinOpsGuard, SecurityBlockException

guard = NexusFinOpsGuard(mode="embedded", spend_threshold=100)
...
## LangChain with NexusSecureTool

```python
"""
Nexus Guard + LangChain NexusSecureTool
=========================================
Run: pip install "nexus-guard[langchain]" && python example_langchain.py
"""
from langchain_core.tools import tool
...
```python
"""
Nexus Guard — Async Tools Example
====================================
...
```python
"""
Nexus Guard — MPP (Machine Payments Protocol) Example
========================================================
...
guard = NexusFinOpsGuard(mode="embedded", spend_threshold=5)
mpp = MPPGuard(guard)
...
```python
"""
Nexus Guard — Human-in-the-Loop Example
==========================================
...
```python
"""
Nexus Guard — Dashboard Reporting Example
============================================
...
```python
"""
Nexus Guard — Production Agent Pattern
=========================================
