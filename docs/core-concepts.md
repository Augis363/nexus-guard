...
Understand the security model that powers Nexus Guard.
...
Nexus Guard sits between the LLM's decision and the tool's execution. Your LLM decides *what* to do. Nexus Guard decides *whether it's allowed*.
