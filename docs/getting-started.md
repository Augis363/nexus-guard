...
Get Nexus Guard protecting your AI agent in under 5 minutes.
...
pip install "nexus-guard[langchain]"

# Development / testing
pip install "nexus-guard[dev]"
```

### Install from source

```bash
git clone https://github.com/Augis363/nexus-guard.git
cd nexus-guard
pip install -e ".[dev]"
```
