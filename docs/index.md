...
- **Install:** `pip install nexus-guard`
- **GitHub:** [github.com/Augis363/nexus-guard](https://github.com/Augis363/nexus-guard)
- **License:** MIT

---

## What Nexus Guard Protects Against

| Threat | Without Nexus Guard | With Nexus Guard |
|:-------|:--------------------|:-----------------|
...
Nexus Guard works with any Python-based agent framework:

- 🕸️ **LangGraph** — `@guard.wrap_tool` decorator + `NexusSecureTool`
- 🦜 **LangChain** — `NexusSecureTool` BaseTool wrapper
